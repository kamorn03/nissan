        ...
        <div class="row">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div id="step1">
                                    <div class="text-center">
                                        ...
                                        <div class="pull-right"> <button style="border: 0;" data-dismiss="modal"> X
                                            </button></div>
                                        <div class="process">
                                ...
                                <div id="step2" class="fade hidden">
                                    ...
                                    <div class="text-center">
                                        <div class="text-center lds-ring hidden">
                                            <div></div>
                                            <div></div>
                                            <div></div>
                                            <div></div>
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="time">
                                                ...
                                                <div class="time__input">
                                                    ...
                                                    <input type="text" name="time" id="datetimepicker3"
                                                        class="datetimepicker-input" data-toggle="datetimepicker"
                        ...
                        <div class="modal-footer mb-5">
                            ...
                            <button type="button" class="btn btn-default btn-close hidden"
            ...
            <div class="container">
                ...
                <div class="text-center mt-3">
                    <p style="color: red;margin-bottom: 15px;"> อยากได้รถแบบไหนบอกเราได้ </p>
